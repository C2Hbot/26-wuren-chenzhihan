...
(cl:defclass <ConeDetections> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (cone_detections
    ...
    :type (cl:vector rviz_test-msg:Cone)
   :initform (cl:make-array 0 :element-type 'rviz_test-msg:Cone :initial-element (cl:make-instance 'rviz_test-msg:Cone))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ConeDetections>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConeDetections)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rviz_test-msg:<ConeDetections> is deprecated: use rviz_test-msg:ConeDetections instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ConeDetections>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rviz_test-msg:header-val is deprecated.  Use rviz_test-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'cone_detections-val :lambda-list '(m))
(cl:defmethod cone_detections-val ((m <ConeDetections>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rviz_test-msg:cone_detections-val is deprecated.  Use rviz_test-msg:cone_detections instead.")
  (cone_detections m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ConeDetections>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'cone_detections)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'rviz_test-msg:Cone))
