...
(cl:defmethod cl:initialize-instance :after ((m <Cone>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Cone)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rviz_test-msg:<Cone> is deprecated: use rviz_test-msg:Cone instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <Cone>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rviz_test-msg:position-val is deprecated.  Use rviz_test-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'color-val :lambda-list '(m))
(cl:defmethod color-val ((m <Cone>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rviz_test-msg:color-val is deprecated.  Use rviz_test-msg:color instead.")
  (color m))

(cl:ensure-generic-function 'poseConfidence-val :lambda-list '(m))
(cl:defmethod poseConfidence-val ((m <Cone>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rviz_test-msg:poseConfidence-val is deprecated.  Use rviz_test-msg:poseConfidence instead.")
  (poseConfidence m))

(cl:ensure-generic-function 'colorConfidence-val :lambda-list '(m))
(cl:defmethod colorConfidence-val ((m <Cone>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rviz_test-msg:colorConfidence-val is deprecated.  Use rviz_test-msg:colorConfidence instead.")
  (colorConfidence m))
