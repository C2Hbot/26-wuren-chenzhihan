...
if("TRUE" STREQUAL "TRUE")
  set(pcl_test_SOURCE_PREFIX /home/c/demo_pcl/src/pcl_test)
  set(pcl_test_DEVEL_PREFIX /home/c/demo_pcl/devel)
  set(pcl_test_INSTALL_PREFIX "")
  set(pcl_test_PREFIX ${pcl_test_DEVEL_PREFIX})
else()
  set(pcl_test_SOURCE_PREFIX "")
  set(pcl_test_DEVEL_PREFIX "")
  set(pcl_test_INSTALL_PREFIX /home/c/demo_pcl/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pcl_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/c/demo_pcl/src/pcl_test/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/c/demo_pcl/devel/lib;/opt/ros/noetic/lib)
